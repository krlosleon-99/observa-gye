...
CREATE OR REPLACE VIEW public.tbv_observaciones
 ...
 SELECT o.id_observacion,
   ...
   FROM observaciones o
     ...
     LEFT JOIN categorias_especies ce ON e.id_categoria_especies= ce.id_categoria_especie
...
CREATE OR REPLACE VIEW public.tbv_last_observations
 ...
 SELECT a.id_observacion,
   ...
   FROM observaciones a
     ...
     JOIN usuarios c ON a.id_usuario = c.id_usuario
     JOIN senderos d ON a.id_sendero = d.id_sendero
     JOIN categorias_especies e ON b.id_categoria_especies= e.id_categoria_especie
...
CREATE OR REPLACE VIEW tbv_especies
 ...
 SELECT e.id_especie,
    e.nombre_comun,
    e.nombre_cientifico,
    e.id_categoria_especies,
    c.nombre_categoria,
    e.imagen,
    e.fecha_creado,
    e.fecha_modificado
   FROM especies e
     JOIN categorias_especies c ON e.id_categoria_especies= c.id_categoria_especie;
